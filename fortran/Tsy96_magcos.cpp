...
/* Subroutine */ int mcos_t96_01___(integer *iopt, real *parmod, real *ps, 
	real *x, real *y, real *z__, real *bx, real *by, real *bz)
{
    ...
    static real a[9] = { (float)1.162,(float)22.344,(float)18.5,(float)2.602,(
    ...
    extern /* Subroutine */ int rmco_dipole_tsy96__(real *, real *, real *, 
	    real *, real *, real *, real *);
    static doublereal x0, am, bt, ct, fx, fy, fz, st;
    ...
    static real pdyn;
    static doublereal xmxm;
    extern /* Subroutine */ int rmco_dipshld__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), rmco_tailrc96__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static doublereal sigma, theta;
    static real byimf, bzimf;
    static doublereal xappa, oimfx, oimfy, oimfz, rimfx, rimfy, rimfz, b1ampl,
	     b2ampl, xappa3, tampl2, tampl3;
    extern /* Subroutine */ int rmco_intercon__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *);
    static doublereal factpd, rcampl, factor, reconn, rimfys, rimfzs, factimf;
    extern /* Subroutine */ int rmco_birk1tot_02__(doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), rmco_birk2tot_02__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal facteps;
...
/* ---------------------------------------------------------------------- */
    ...
    byimf = parmod[3];
    bzimf = parmod[4];
/*       print*,PARMOD(1),PARMOD(2),PARMOD(3),PARMOD(4) */
/*       print*,PS */
/*       print*,X,Y,Z */
/*       print*,B0DIP */
...
/*  CALCULATE THE T95_06 FIELD (WITH TH */
	rmco_dipshld__(&pps, &xx, &yy, &zz, &cfx, &cfy, &cfz);
	rmco_tailrc96__(&sps, &xx, &yy, &zz, &bxrc, &byrc, &bzrc, &bxt2, &
		byt2, &bzt2, &bxt3, &byt3, &bzt3);
	rmco_birk1tot_02__(&pps, &xx, &yy, &zz, &r1x, &r1y, &r1z);
	rmco_birk2tot_02__(&pps, &xx, &yy, &zz, &r2x, &r2y, &r2z);
	d__1 = ys * xappa;
	d__2 = zs * xappa;
	rmco_intercon__(&xx, &d__1, &d__2, &rimfx, &rimfys, &rimfzs);
	rimfy = rimfys * ct + rimfzs * st;
	rimfz = rimfzs * ct - rimfys * st;
	factor = bdip_1.b0dip / (float)30574.;
	fx = cfx * factor * xappa3 + rcampl * bxrc + tampl2 * bxt2 + tampl3 * 
		bxt3 + b1ampl * r1x + b2ampl * r2x + rimfampl * rimfx;
	fy = cfy * factor * xappa3 + rcampl * byrc + tampl2 * byt2 + tampl3 * 
		byt3 + b1ampl * r1y + b2ampl * r2y + rimfampl * rimfy;
	fz = cfz * factor * xappa3 + rcampl * bzrc + tampl2 * bzt2 + tampl3 * 
		bzt3 + b1ampl * r1z + b2ampl * r2z + rimfampl * rimfz;
...
/*  THIS IS THE MOST COMPLEX CASE: WE ARE I */
	    ...
	    rmco_dipole_tsy96__(ps, x, y, z__, &qx, &qy, &qz);
...
/* ===================================================================== */
/* Subroutine */ int rmco_dipshld__(doublereal *ps, doublereal *x, doublereal 
	*y, doublereal *z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    ...
    extern /* Subroutine */ int rmco_cylhar1__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), rmco_cylharm__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
...
/*    SHIELDING OF THE EARTH'S DIPOLE ONLY */
    ...
    cps = cos(*ps);
    sps = sin(*ps);
    rmco_cylharm__(a1, x, y, z__, &hx, &hy, &hz);
    rmco_cylhar1__(a2, x, y, z__, &fx, &fy, &fz);
...
/* Subroutine */ int rmco_cylharm__(doublereal *a, doublereal *x, doublereal *
	y, doublereal *z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* System generated locals */
    doublereal d__1, d__2;
    ...
    /* Local variables */
    extern doublereal rmco_bes__(doublereal *, integer *);
    static integer i__;
    static doublereal xj0, xj1, rho, bphi, brho, xksi, xexp, si2co2, cosfi, 
	    dzeta, sinfi, sinfi2;
...
/* Computing 2nd power */
    ...
    *bz = 0.;
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
	dzeta = rho / a[i__ + 6];
	xj0 = rmco_bes__(&dzeta, &c__0);
	xj1 = rmco_bes__(&dzeta, &c__1);
	xexp = exp(*x / a[i__ + 6]);
...
/* Subroutine */ int rmco_cylhar1__(doublereal *a, doublereal *x, doublereal *
	y, doublereal *z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* System generated locals */
    doublereal d__1, d__2;
    ...
    extern doublereal rmco_bes__(doublereal *, integer *);
    static integer i__;
    static doublereal xj0, xj1, rho, brho, xksi, xexp, cosfi, dzeta, sinfi;
...
doublereal rmco_bes__(doublereal *x, integer *k)
{
    /* System generated locals */
    doublereal ret_val;

    /* Local variables */
    extern doublereal rmco_bes0__(doublereal *), rmco_bes1__(doublereal *);
    static doublereal g;
    static integer n;
    static doublereal bes, xjn, sum, xjnm1, xjnp1;


    if (*k == 0) {
	ret_val = rmco_bes0__(x);
	return ret_val;
    }

    if (*k == 1) {
	ret_val = rmco_bes1__(x);
	return ret_val;
    }
...
doublereal rmco_bes0__(doublereal *x)
{
    /* System generated locals */
...
doublereal rmco_bes1__(doublereal *x)
{
    /* System generated locals */
    doublereal ret_val, d__1;
...
/* Subroutine */ int rmco_intercon__(doublereal *x, doublereal *y, doublereal 
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/* Subroutine */ int rmco_tailrc96__(doublereal *sps, doublereal *x, 
	doublereal *y, doublereal *z__, doublereal *bxrc, doublereal *byrc, 
	doublereal *bzrc, doublereal *bxt2, doublereal *byt2, doublereal *
	bzt2, doublereal *bxt3, doublereal *byt3, doublereal *bzt3)
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal c__, r__, w, c1, c11, c12, cs, hx, hy, hz, ws, wx, wy, 
	    wz;
    extern /* Subroutine */ int rmco_tail87__(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal dr2, sq1, sq2;
    extern /* Subroutine */ int rmco_taildisk_tsy96__(doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), rmco_shlcar3x3_tsy96__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal wfac, dddy, spsc1;
    extern /* Subroutine */ int rmco_ringcurr96__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *);
...
/*  THIS IS THE SAME SIMPLE WAY TO SPRE */
    ...
    rmco_shlcar3x3_tsy96__(arc, x, y, z__, sps, &wx, &wy, &wz);
    rmco_ringcurr96__(x, y, z__, &hx, &hy, &hz);
    *bxrc = wx + hx;
    *byrc = wy + hy;
    *bzrc = wz + hz;

    rmco_shlcar3x3_tsy96__(atail2, x, y, z__, sps, &wx, &wy, &wz);
    rmco_taildisk_tsy96__(x, y, z__, &hx, &hy, &hz);
    *bxt2 = wx + hx;
    *byt2 = wy + hy;
    *bzt2 = wz + hz;

    rmco_shlcar3x3_tsy96__(atail3, x, y, z__, sps, &wx, &wy, &wz);
    rmco_tail87__(x, z__, &hx, &hz);
    *bxt3 = wx + hx;
    *byt3 = wy;
    *bzt3 = wz + hz;
...
/* Subroutine */ int rmco_ringcurr96__(doublereal *x, doublereal *y, 
...
/*       THIS SUBROUTINE RMCO_COMPUTES THE COMPONENTS OF THE RING CURRENT FIELD, */
...
/* Subroutine */ int rmco_taildisk_tsy96__(doublereal *x, doublereal *y, 
	doublereal *z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
...
/* Computing 2nd power */
	...
	*bz += f[i__ - 1] * ((as * 2. + *y * dasdy) * warp_3.cpss + (
    ...
    return 0;
} /* rmco_taildisk_tsy96__ */

/* ------------------------------------------------------------------------- */

/* Subroutine */ int rmco_tail87__(doublereal *x, doublereal *z__, doublereal 
	*bx, doublereal *bz)
{
    /* Initialized data */
...
/*           MAIN SUBROUTINE RMCO_(TAILRC96) FROM THE PARAMETERS RH AND DR OF THE */
/*           T96-TYPE MODULE, AND */
...
/* Subroutine */ int rmco_shlcar3x3_tsy96__(doublereal *a, doublereal *x, 
	doublereal *y, doublereal *z__, doublereal *sps, doublereal *hx, 
...
/* L1: */
    ...
    return 0;
} /* rmco_shlcar3x3_tsy96__ */


/* @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ */

/* Subroutine */ int rmco_birk1tot_02__(doublereal *ps, doublereal *x, 
	doublereal *y, doublereal *z__, doublereal *bx, doublereal *by, 
	doublereal *bz)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int rmco_condip1__(doublereal *, doublereal *);
    static doublereal frac, dtet, rmrh, stas, rprh, ct01as, ct02as;
    extern /* Subroutine */ int rmco_diploop1__(doublereal *, doublereal *);
    static doublereal cpsas, st01as, st02as, spsas, tetr1n, tetr1s;
    extern /* Subroutine */ int rmco_birk1shld__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal dtetdn, tnoonn, tnoons;
...
/* END OF THE CASE 4 */
    rmco_birk1shld__(ps, x, y, z__, &bsx, &bsy, &bsz);
    *bx += bsx;
    *by += bsy;
    *bz += bsz;
    return 0;
...
/* Subroutine */ int rmco_diploop1__(doublereal *xi, doublereal *d__)
{
    /* System generated locals */
    doublereal d__1, d__2, d__3;
    ...
    static doublereal q, r__, x, y, z__, r2, bx, xd, yd, zd, by, bz, ps, dr2, 
	    sqm, sqp, sps;
    extern /* Subroutine */ int rmco_circle__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal bx1x, by1x, bz1x, bx1y, by1y, bz1y, bx1z, by1z, bz1z, 
	    bx2x, by2x, bz2x, bx2y, by2y, bz2y, bx2z, by2z, bz2z;
    extern /* Subroutine */ int rmco_dipxyz__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal rmrh, rprh, xoct1, yoct1, zoct1, xoct2, yoct2;
    extern /* Subroutine */ int rmco_crosslp__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static doublereal zoct2, cpsas, spsas, bxoct1, byoct1, bzoct1;
...
/* Computing 2nd power */
	...
	d__2 = y - yd;
	d__3 = z__ - zd;
	rmco_dipxyz__(&d__1, &d__2, &d__3, &bx1x, &by1x, &bz1x, &bx1y, &by1y, 
		&bz1y, &bx1z, &by1z, &bz1z);
	if (abs(yd) > 1e-10) {
	    d__1 = x - xd;
	    d__2 = y + yd;
	    d__3 = z__ - zd;
	    rmco_dipxyz__(&d__1, &d__2, &d__3, &bx2x, &by2x, &bz2x, &bx2y, &
...
/* Computing 2nd power */
    ...
    rmco_crosslp__(&xoct1, &yoct1, &zoct1, &bxoct1, &byoct1, &bzoct1, 
...
/* Computing 2nd power */
    ...
    rmco_circle__(&xoct2, &yoct2, &zoct2, &loopdip1_1.radius[1], &bx, &by, &
	    bz);
...
/* Subroutine */ int rmco_circle__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *rl, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
...
/* Subroutine */ int rmco_crosslp__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bx, doublereal *by, doublereal *bz, doublereal *xc, 
...
/*     X-DIRECTION BY THE DISTANCE  XC. */
    ...
    z2 = -(*y) * sal + *z__ * cal;
    d__1 = *x - *xc;
    rmco_circle__(&d__1, &y1, &z1, rl, &bx1, &by1, &bz1);
    d__1 = *x - *xc;
    rmco_circle__(&d__1, &y2, &z2, rl, &bx2, &by2, &bz2);
    *bx = bx1 + bx2;
...
/* ******************************************************************* */
/* Subroutine */ int rmco_dipxyz__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bxx, doublereal *byx, doublereal *bzx, doublereal *
	bxy, doublereal *byy, doublereal *bzy, doublereal *bxz, doublereal *
	byz, doublereal *bzz)
{
    /* System generated locals */
    doublereal d__1;
...
/* ------------------------------------------------------------------------------ */
/* Subroutine */ int rmco_condip1__(doublereal *xi, doublereal *d__)
{
    /* System generated locals */
    integer i__1, i__2;
    doublereal d__1, d__2, d__3;
    ...
    static doublereal ro2, cnh, cps, tnh, sps, xsm, zsm, bx1x, by1x, bz1x, 
	    ...
	    bz2y, bx2z, by2z, bz2z, bx3x;
    extern /* Subroutine */ int rmco_dipxyz__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal by3x, bz3x, bx3y, by3y, bz3y, bx3z, by3z, bz3z, bx4x, 
	    by4x, bz4x, bx4y, by4y, bz4y, bx4z, by4z, bz4z, bxsm, bzsm;
...
/* L1: */
	...
	d__2 = y + yd;
	d__3 = zsm - zd;
	rmco_dipxyz__(&d__1, &d__2, &d__3, &bx2x, &by2x, &bz2x, &bx2y, &by2y, 
		&bz2y, &bx2z, &by2z, &bz2z);
	d__1 = xsm - xd;
	d__2 = y - yd;
	d__3 = zsm + zd;
	rmco_dipxyz__(&d__1, &d__2, &d__3, &bx3x, &by3x, &bz3x, &bx3y, &by3y, 
		&bz3y, &bx3z, &by3z, &bz3z);
	d__1 = xsm - xd;
	d__2 = y + yd;
	d__3 = zsm + zd;
	rmco_dipxyz__(&d__1, &d__2, &d__3, &bx4x, &by4x, &bz4x, &bx4y, &by4y, 
		&bz4y, &bx4z, &by4z, &bz4z);
...
/* L2: */
	...
	d__1 = zsm - zd;
	rmco_dipxyz__(&xsm, &y, &d__1, &bx1x, &by1x, &bz1x, &bx1y, &by1y, &
		bz1y, &bx1z, &by1z, &bz1z);
	d__1 = zsm + zd;
	rmco_dipxyz__(&xsm, &y, &d__1, &bx2x, &by2x, &bz2x, &bx2y, &by2y, &
		bz2y, &bx2z, &by2z, &bz2z);
	ix = (i__ << 1) + 58;
	iz = ix + 1;
...
/* Subroutine */ int rmco_birk1shld__(doublereal *ps, doublereal *x, 
	doublereal *y, doublereal *z__, doublereal *bx, doublereal *by, 
	doublereal *bz)
{
    /* Initialized data */
...
/* Subroutine */ int rmco_birk2tot_02__(doublereal *ps, doublereal *x, 
	doublereal *y, doublereal *z__, doublereal *bx, doublereal *by, 
	doublereal *bz)
{
    static doublereal hx, hy, hz, wx, wy, wz;
    extern /* Subroutine */ int rmco_r2_birk__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), rmco_birk2shl__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);



    rmco_birk2shl__(x, y, z__, ps, &wx, &wy, &wz);
    rmco_r2_birk__(x, y, z__, ps, &hx, &hy, &hz);
    *bx = wx + hx;
    *by = wy + hy;
    *bz = wz + hz;
    return 0;
...
/* Subroutine */ int rmco_birk2shl__(doublereal *x, doublereal *y, doublereal 
	*z__, doublereal *ps, doublereal *hx, doublereal *hy, doublereal *hz)
{
    /* Initialized data */
...
/* Subroutine */ int rmco_r2_birk__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *ps, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
    ...
    extern doublereal rmco_tksi__(doublereal *, doublereal *, doublereal *), 
	    rmco_xksi__(doublereal *, doublereal *, doublereal *);
    static doublereal by1, by2, cps, sps, xks, xsm, zsm;
    extern /* Subroutine */ int rmco_r2sheet__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *), 
	    rmco_r2inner__(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *);
    static doublereal bxsm, bzsm;
    extern /* Subroutine */ int rmco_r2outer__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *);
...
/*    (WITHOUT SHIELDING FIELD) */
    ...
    xks = rmco_xksi__(&xsm, y, &zsm);
    if (xks < -(delarg + delarg1)) {
	rmco_r2outer__(&xsm, y, &zsm, &bxsm, by, &bzsm);
	bxsm = -bxsm * (float).02;
...
/*  FIELD (SO THAT Bz=-1 nT at X=-5.3 RE, Y */
	...
	rmco_r2outer__(&xsm, y, &zsm, &bxsm1, &by1, &bzsm1);
	rmco_r2sheet__(&xsm, y, &zsm, &bxsm2, &by2, &bzsm2);
	d__1 = -delarg;
	f2 = rmco_tksi__(&xks, &d__1, &delarg1) * (float)-.02;
	f1 = (float)-.02 - f2;
	...
	*by = by1 * f1 + by2 * f2;
    ...
    if (xks >= -delarg + delarg1 && xks < delarg - delarg1) {
	rmco_r2sheet__(&xsm, y, &zsm, &bxsm, by, &bzsm);
	bxsm = -bxsm * (float).02;
	*by = -(*by) * (float).02;
	bzsm = -bzsm * (float).02;
    }
    if (xks >= delarg - delarg1 && xks < delarg + delarg1) {
	rmco_r2inner__(&xsm, y, &zsm, &bxsm1, &by1, &bzsm1);
	rmco_r2sheet__(&xsm, y, &zsm, &bxsm2, &by2, &bzsm2);
	f1 = rmco_tksi__(&xks, &delarg, &delarg1) * (float)-.02;
	f2 = (float)-.02 - f1;
	bxsm = bxsm1 * f1 + bxsm2 * f2;
	*by = by1 * f1 + by2 * f2;
	bzsm = bzsm1 * f1 + bzsm2 * f2;
    ...
    if (xks >= delarg + delarg1) {
	rmco_r2inner__(&xsm, y, &zsm, &bxsm, by, &bzsm);
	bxsm = -bxsm * (float).02;
	*by = -(*by) * (float).02;
	bzsm = -bzsm * (float).02;
    }
...
/* Subroutine */ int rmco_r2inner__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal cbx[5], cby[5], cbz[5];
    extern /* Subroutine */ int rmco_loops4__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *), rmco_bconic__(doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *);
    static doublereal dbx6, dby6, dbx8, dby8, dbz8, dbz6, dbx7, dby7, dbz7;
    extern /* Subroutine */ int rmco_dipdistr__(doublereal *, doublereal *, 
    ...
    rmco_bconic__(x, y, z__, cbx, cby, cbz, &c__5);

/*   NOW INTRODUCE  ONE  4-LOOP SYSTEM: */

    rmco_loops4__(x, y, z__, &dbx8, &dby8, &dbz8, &pn1, &pn2, &pn3, &pn4, &
	    pn5, &pn6);

    d__1 = *x - pn7;
    rmco_dipdistr__(&d__1, y, z__, &dbx6, &dby6, &dbz6, &c__0);
    d__1 = *x - pn8;
    rmco_dipdistr__(&d__1, y, z__, &dbx7, &dby7, &dbz7, &c__1);
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ int rmco_bconic__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *cbx, doublereal *cby, doublereal *cbz, integer *nmax)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1, d__2;
...
/* Subroutine */ int rmco_dipdistr__(doublereal *x, doublereal *y, doublereal 
	*z__, doublereal *bx, doublereal *by, doublereal *bz, integer *mode)
{
    /* System generated locals */
    doublereal d__1;
...
/* Subroutine */ int rmco_r2outer__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int rmco_loops4__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *), rmco_circle__(doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
...
/*    THREE PAIRS OF CROSSED LOOPS: */
    ...
    rmco_crosslp__(x, y, z__, &dbx1, &dby1, &dbz1, &pn1, &pn2, &pn3);
    rmco_crosslp__(x, y, z__, &dbx2, &dby2, &dbz2, &pn4, &pn5, &pn6);
    rmco_crosslp__(x, y, z__, &dbx3, &dby3, &dbz3, &pn7, &pn8, &pn9);

/*    NOW AN EQUATORIAL LOOP ON THE NIGHTSIDE */

    d__1 = *x - pn10;
    rmco_circle__(&d__1, y, z__, &pn11, &dbx4, &dby4, &dbz4);

/*   NOW A 4-LOOP SYSTEM ON THE NIGHTSIDE */

    rmco_loops4__(x, y, z__, &dbx5, &dby5, &dbz5, &pn12, &pn13, &pn14, &pn15, 
	    &pn16, &pn17);
/* --------------------------------------------------------------------- */
/*                           NOW COMPUTE THE FIELD COMPONENTS: */
...
/* Subroutine */ int rmco_loops4__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bx, doublereal *by, doublereal *bz, doublereal *xc, 
	...
	doublereal *phi)
{
    ...
    static doublereal cp, ct, sp, st, xs, zs, bx1, by1, bz1, bz2, bx2, by2, 
	    bz3, bx3, by3, bz4, bx4, by4, bxs, bys, xss, yss, zss;
    extern /* Subroutine */ int rmco_circle__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal bxss, bzss;
...
/* ------------------------------------1ST QUADRANT: */
    ...
    xss = xs * ct - zs * st;
    zss = zs * ct + xs * st;
    rmco_circle__(&xss, &yss, &zss, r__, &bxss, &bys, &bzss);
    bxs = bxss * ct + bzss * st;
    bz1 = bzss * ct - bxss * st;
    bx1 = bxs * cp - bys * sp;
    by1 = bxs * sp + bys * cp;
...
/* Subroutine */ int rmco_r2sheet__(doublereal *x, doublereal *y, doublereal *
	z__, doublereal *bx, doublereal *by, doublereal *bz)
{
    /* Initialized data */
    ...
    extern doublereal rmco_xksi__(doublereal *, doublereal *, doublereal *);
    static doublereal s1;
    extern doublereal rmco_fexp__(doublereal *, doublereal *);
    static doublereal s2, s3, s4, s5, xks, t1x, t2x, t3x, t1y, t2y, t3y, t1z, 
	    t2z, t3z, rho2, rho, c1p, s1p, s2p, c2p, s3p, c3p, s4p, ct, st;
    extern doublereal rmco_fexp1__(doublereal *, doublereal *);
...
/* Computing 4th power */
    ...
    s1 = rmco_fexp__(&ct, &pnonx1);
    s2 = rmco_fexp__(&ct, &pnonx2);
    s3 = rmco_fexp__(&ct, &pnonx3);
    s4 = rmco_fexp__(&ct, &pnonx4);
    s5 = rmco_fexp__(&ct, &pnonx5);
...
/*                   NOW COMPUTE THE GSM FIELD COMPONENTS: */
    ...
    *bx = s1 * (a1 + a2 * t1x + a3 * t2x + a4 * t3x + c1p * (a5 + a6 * t1x + 
    ...
    s1 = rmco_fexp__(&ct, &pnony1);
    s2 = rmco_fexp__(&ct, &pnony2);
    s3 = rmco_fexp__(&ct, &pnony3);
    s4 = rmco_fexp__(&ct, &pnony4);
    s5 = rmco_fexp__(&ct, &pnony5);
    ...
    *by = s1 * (s1p * (b1 + b2 * t1y + b3 * t2y + b4 * t3y) + s2p * (b5 + b6 *
    ...
    s1 = rmco_fexp1__(&ct, &pnonz1);
    s2 = rmco_fexp1__(&ct, &pnonz2);
    s3 = rmco_fexp1__(&ct, &pnonz3);
    s4 = rmco_fexp1__(&ct, &pnonz4);
    s5 = rmco_fexp1__(&ct, &pnonz5);
...
/* ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ */
doublereal rmco_xksi__(doublereal *x, doublereal *y, doublereal *z__)
{
    /* Initialized data */
...
/* Computing 2nd power */
    ...
    if (fchsg2 < 1e-5) {
	ret_val = -1.;
/*  THIS IS JUST FOR ELIMINATING P */
	return ret_val;
/*  ON THE Z-AXIS */
    }
...
doublereal rmco_fexp__(doublereal *s, doublereal *a)
{
    /* Initialized data */
...
/* ----------------------------------------------------------------------- */
doublereal rmco_fexp1__(doublereal *s, doublereal *a)
{
    /* System generated locals */
    doublereal ret_val;
...
doublereal rmco_tksi__(doublereal *xksi, doublereal *xks0, doublereal *dxksi)
{
    /* Initialized data */
...
/* Subroutine */ int rmco_dipole_tsy96__(real *ps, real *x, real *y, real *
	z__, real *bx, real *by, real *bz)
{
    /* Initialized data */

    static integer m = 0;
    static real psi = (float)5.;
...
/*                           RUSSIA */
    ...
    if (m == 1 && (r__1 = *ps - psi, dabs(r__1)) < (float)1e-5) {
	goto L1;
    }
    sps = sin(*ps);
    cps = cos(*ps);
